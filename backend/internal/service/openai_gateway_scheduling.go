...
// NormalizeOpenAICompatiblePlatform 保留 grok、OpenCode、CodeBuddy 与国产 OpenAI 兼容供应商
...
func NormalizeOpenAICompatiblePlatform(platform string) string {
	switch platform {
	case PlatformGrok, PlatformOpenCode, PlatformKimi, PlatformZhipu, PlatformDeepseek, PlatformCodeBuddy:
		return platform
	default:
