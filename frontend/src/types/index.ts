...
export type GroupPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'grok' | 'kimi' | 'zhipu' | 'deepseek' | 'opencode' | 'codebuddy' | 'minimax' | 'opencode_go' | 'composite'
...
export type AccountPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'grok' | 'kimi' | 'zhipu' | 'deepseek' | 'opencode' | 'codebuddy' | 'minimax' | 'opencode_go'
