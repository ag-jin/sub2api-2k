...
export type Platform = 'anthropic' | 'openai' | 'antigravity' | 'gemini' | 'grok' | 'kiro' | 'deepseek' | 'opencode'
...
const BADGE: Record<Platform, string> = {
  ...
  opencode: 'bg-violet-500/10 text-violet-600 border-violet-500/30 dark:text-violet-400',
}
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  opencode: 'bg-violet-500/10 text-violet-600 dark:bg-violet-500/10 dark:text-violet-300',
}
...
const BORDER: Record<Platform, string> = {
  ...
  opencode: 'border-violet-500/20 dark:border-violet-500/20',
}
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  opencode: 'bg-gradient-to-r from-violet-400 to-violet-500',
}
...
const TEXT: Record<Platform, string> = {
  ...
  opencode: 'text-violet-600 dark:text-violet-400',
}
...
const ICON: Record<Platform, string> = {
  ...
  opencode: 'text-violet-500 dark:text-violet-400',
}
...
const BUTTON: Record<Platform, string> = {
  ...
  opencode: 'bg-violet-500 text-white hover:bg-violet-600 active:bg-violet-700 dark:bg-violet-500/80 dark:hover:bg-violet-500',
}
...
const DISCOUNT: Record<Platform, string> = {
  ...
  opencode: 'bg-violet-100 text-violet-700 dark:bg-violet-900/40 dark:text-violet-300',
}
...
const GRADIENT: Record<Platform, string> = {
  ...
  opencode: 'from-violet-500 to-violet-600',
}
...
function isPlatform(p: string): p is Platform {
  return p === 'anthropic' || p === 'openai' || p === 'antigravity' || p === 'gemini' || p === 'grok' || p === 'kiro' || p === 'deepseek' || p === 'opencode'
}
