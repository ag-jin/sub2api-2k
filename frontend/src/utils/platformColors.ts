...
const BADGE: Record<Platform, string> = {
  ...
  opencode: 'bg-indigo-500/10 text-indigo-600 border-indigo-500/30 dark:text-indigo-400',
...
const TEXT: Record<Platform, string> = {
  ...
  opencode: 'text-indigo-600 dark:text-indigo-400',
...
const ICON: Record<Platform, string> = {
  ...
  opencode: 'text-indigo-500 dark:text-indigo-400',
...
const BUTTON: Record<Platform, string> = {
  ...
  opencode: 'bg-indigo-500 text-white hover:bg-indigo-600 active:bg-indigo-700 dark:bg-indigo-500/80 dark:hover:bg-indigo-500',
