...
export type Platform = 'anthropic' | 'openai' | 'antigravity' | 'gemini' | 'kiro' | 'deepseek' | 'opencode'
...
function isPlatform(p: string): p is Platform {
  return p === 'anthropic' || p === 'openai' || p === 'antigravity' || p === 'gemini' || p === 'kiro' || p === 'deepseek' || p === 'opencode'
}
