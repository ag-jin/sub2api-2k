 ...
 * Create new API key
 * @param name - Key name
 * @param pricingPlanId - Optional pricing plan ID to bind (mutually exclusive with group_id)
...
export async function create(
  ...
  if (pricingPlanId !== undefined && pricingPlanId !== null) {
    payload.pricing_plan_id = pricingPlanId
  }
  if (customKey) {
