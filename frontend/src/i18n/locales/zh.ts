  ...
  admin: {
    ...
    accounts: {
      ...
      opencode: {
        ...
        proxyUrl: '代理 URL（可选）',
        loginTitle: '社交登录（可选，仅记录身份）',
        loginHint: '通过 GitHub/Google 登录 OpenCode 验证身份并记录邮箱。注意：登录不会自动获取 API Key，sk- key 仍需在下方手动填写。',
        codePaste: '粘贴回调地址或 code',
        codePastePlaceholder: '登录后从 localhost 回调地址栏复制完整 URL 或 code',
      },
