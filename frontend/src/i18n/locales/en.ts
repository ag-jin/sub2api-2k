export default {
  ...
  usage: {
    ...
    localEstimate: 'Local estimate (no upstream usage API)',
    resetNow: 'Now',
  ...
  admin: {
    ...
    accounts: {
      ...
      opencode: {
        ...
        proxyUrl: 'Proxy URL (Optional)',
        loginTitle: 'Social login (optional, identity only)',
        loginHint: 'Log in to OpenCode via GitHub/Google to verify identity and record the email. Note: login does NOT fetch the API key automatically — you still enter the sk- key below.',
        codePaste: 'Paste callback URL or code',
        codePastePlaceholder: 'After login, copy the full localhost callback URL or the code',
      },
